...
const PopupWidget = () => {
  ...
  const accessKey = 'dfa16a58-f7ad-44d8-abef-b201460e1a9b';
  ...
  return (
    <div>
      <Disclosure>
        {({ open }) => (
          <>
            <Disclosure.Button className="fixed z-40 flex items-center justify-center transition duration-300 bg-sky-500 rounded-full shadow-lg right-5 bottom-5 w-14 h-14 focus:outline-none hover:bg-sky-600 focus:bg-sky-600 ease">
